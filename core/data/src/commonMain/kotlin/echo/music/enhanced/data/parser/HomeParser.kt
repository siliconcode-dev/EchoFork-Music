...
import echo.music.enhanced.kotlinytmusicscraper.models.SectionListRenderer
import echo.music.enhanced.kotlinytmusicscraper.models.SongItem
import echo.music.enhanced.kotlinytmusicscraper.models.Thumbnail
...
fun Thumbnail.toThumbnail(): echo.music.enhanced.domain.data.model.searchResult.songs.Thumbnail =
    echo.music.enhanced.domain.data.model.searchResult.songs.Thumbnail(
        height = this.height ?: 0,
        url = this.url,
        width = this.width ?: 0,
    )

fun List<Thumbnail>.toListThumbnail(): List<echo.music.enhanced.domain.data.model.searchResult.songs.Thumbnail> {
    val list = mutableListOf<echo.music.enhanced.domain.data.model.searchResult.songs.Thumbnail>()
    this.forEach {
