...
import echo.music.enhanced.domain.manager.DataStoreManager.Values.REPEAT_ALL
...
import echo.music.enhanced.common.QUALITY as COMMON_QUALITY
...
internal class DataStoreManagerImpl(
    ...
    override val armedIosPillNav: Flow<Boolean> =
        settingsDataStore.data.map { preferences ->
            preferences[ARMED_IOS_PILL_NAV] ?: false
        }

    override suspend fun setArmedIosPillNav(armed: Boolean) {
        withContext(Dispatchers.IO) {
            settingsDataStore.edit { settings ->
                settings[ARMED_IOS_PILL_NAV] = armed
            }
        }
    }
