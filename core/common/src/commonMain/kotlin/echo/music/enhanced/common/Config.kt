...
object MEDIA_NOTIFICATION {
    ...
    const val NOTIFICATION_CHANNEL_NAME = "Enhanced Echo Music Playback Notification"
    const val NOTIFICATION_CHANNEL_ID = "Enhanced Echo Music Playback Notification ID"
}
