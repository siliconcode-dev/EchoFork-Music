package echo.music.enhanced.innertube.models.comment

import echo.music.enhanced.innertube.models.Runs
import echo.music.enhanced.innertube.models.Thumbnails
import echo.music.enhanced.innertube.models.NavigationEndpoint
...
data class CommentThreadRenderer(
    ...
    data class Replies(
        ...
        data class CommentRepliesRenderer(
            ...
            val viewReplies: echo.music.enhanced.innertube.models.Button? = null,
            val hideReplies: echo.music.enhanced.innertube.models.Button? = null,
        ) {
            @Serializable
            data class Content(
...
data class ContinuationItemRenderer(
    ...
    val button: echo.music.enhanced.innertube.models.Button? = null,
) {
    @Serializable
