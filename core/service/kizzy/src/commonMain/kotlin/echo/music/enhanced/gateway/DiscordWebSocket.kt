package echo.music.enhanced.gateway

import echo.music.enhanced.logger.Logger
import echo.music.enhanced.gateway.entities.Heartbeat
import echo.music.enhanced.gateway.entities.Identify.Companion.toIdentifyPayload
import echo.music.enhanced.gateway.entities.Payload
import echo.music.enhanced.gateway.entities.Ready
import echo.music.enhanced.gateway.entities.Resume
import echo.music.enhanced.gateway.entities.op.OpCode
import echo.music.enhanced.gateway.entities.op.OpCode.DISPATCH
import echo.music.enhanced.gateway.entities.op.OpCode.HEARTBEAT
import echo.music.enhanced.gateway.entities.op.OpCode.HELLO
import echo.music.enhanced.gateway.entities.op.OpCode.IDENTIFY
import echo.music.enhanced.gateway.entities.op.OpCode.INVALID_SESSION
import echo.music.enhanced.gateway.entities.op.OpCode.PRESENCE_UPDATE
import echo.music.enhanced.gateway.entities.op.OpCode.RECONNECT
import echo.music.enhanced.gateway.entities.op.OpCode.RESUME
import echo.music.enhanced.gateway.entities.presence.Presence
