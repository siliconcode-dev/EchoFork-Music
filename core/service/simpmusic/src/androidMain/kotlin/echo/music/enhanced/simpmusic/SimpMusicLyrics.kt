package echo.music.enhanced.simpmusic

import echo.music.enhanced.simpmusic.models.LyricsData
import echo.music.enhanced.simpmusic.models.SimpMusicApiResponse
...
object SimpMusicLyrics {
    ...
    suspend fun getLyrics(
        ...
        runCatching {
            ...
            val bestMatch =
                if (duration > 0 && validTracks.size > 1) {
