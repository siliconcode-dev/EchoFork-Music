package echo.music.enhanced.youlyplus

import echo.music.enhanced.youlyplus.models.LyricsResponse
...
object YouLyPlus {
     ...
     */
    private fun List<echo.music.enhanced.youlyplus.models.LyricsItem>.convertToLrc(): String? {
