package echo.music.iad1tya.media3.di
...
import echo.music.iad1tya.media3.cast.CastHandoffManager
import echo.music.iad1tya.media3.cast.CastStreamResolver
import echo.music.iad1tya.media3.exoplayer.CrossfadeExoPlayerAdapter
import echo.music.iad1tya.media3.extension.isFullyCached
import echo.music.iad1tya.media3.repository.CacheRepositoryImpl
...
import echo.music.iad1tya.media3.service.download.DownloadUtils
...
import echo.music.iad1tya.cast.initCast
import echo.music.iad1tya.cast.wrapWithCastPlayer
...
private val mediaServiceModule =
    module {
        ...
        // Cast support in the full build; echo.music.iad1tya.cast no-ops back to the same instance
