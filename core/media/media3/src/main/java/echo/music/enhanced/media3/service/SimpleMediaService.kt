package echo.music.enhanced.media3.service
...
import echo.music.enhanced.common.MEDIA_NOTIFICATION
...
import echo.music.enhanced.media3.R
import echo.music.enhanced.media3.extension.toCommandButton
...
internal class SimpleMediaService :
    MediaLibraryService(),
    KoinComponent {
    private val coroutineScope by inject<CoroutineScope>(named(echo.music.enhanced.common.Config.SERVICE_SCOPE))
    ...
    private val player: Player by inject<Player>(qualifier = named(echo.music.enhanced.common.Config.MAIN_PLAYER))
