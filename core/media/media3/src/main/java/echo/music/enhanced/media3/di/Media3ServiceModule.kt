package echo.music.enhanced.media3.di
...
import echo.music.enhanced.common.Config.CANVAS_CACHE
import echo.music.enhanced.common.Config.DOWNLOAD_CACHE
import echo.music.enhanced.common.Config.MAIN_PLAYER
import echo.music.enhanced.common.Config.PLAYER_CACHE
...
import echo.music.enhanced.media3.cast.CastHandoffManager
import echo.music.enhanced.media3.cast.CastStreamResolver
import echo.music.enhanced.media3.exoplayer.CrossfadeExoPlayerAdapter
import echo.music.enhanced.media3.extension.isFullyCached
import echo.music.enhanced.media3.repository.CacheRepositoryImpl
import echo.music.enhanced.media3.service.SimpleMediaService
import echo.music.enhanced.media3.service.callback.SimpleMediaSessionCallback
import echo.music.enhanced.media3.service.download.DownloadUtils
import echo.music.enhanced.media3.service.mediasourcefactory.MergingMediaSourceFactory
import echo.music.enhanced.media3.utils.CoilBitmapLoader
...
import echo.music.enhanced.cast.initCast
import echo.music.enhanced.cast.wrapWithCastPlayer
...
private val mediaServiceModule =
    module {
        ...
        // Cast support in the full build; echo.music.enhanced.cast no-ops back to the same instance
