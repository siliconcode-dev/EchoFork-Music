package echo.music.enhanced.media3.exoplayer
...
import echo.music.enhanced.media3.audio.BiquadFilter
import echo.music.enhanced.media3.audio.CrossfadeFilterAudioProcessor
import echo.music.enhanced.media3.audio.EqualizerAudioProcessor
import echo.music.enhanced.media3.audio.EqualizerCurve
import echo.music.enhanced.media3.audio.SleepFadeAudioProcessor
import echo.music.enhanced.media3.exoplayer.CrossfadeExoPlayerAdapter.Companion.SPEED_PITCH_STEP
import echo.music.enhanced.media3.service.mediasourcefactory.MergingMediaSourceFactory
 ...
 *
 * Architecture mirrors [echo.music.enhanced.media_jvm.GstreamerPlayerAdapter]:
    ...
    private fun createExoPlayerInstance(): PlayerWithFilter {
        ...
        val effectiveAudioAttributes =
            AudioAttributes
                ...
                .setIsContentSpatialized(audioAttributes.isContentSpatialized)
                .setHapticChannelsMuted(audioAttributes.hapticChannelsMuted)
                        ...
                        if (retryCount < maxRetryCount) {
                            ...
                            coroutineScope.launch {
                                try {
                                    ...
                                    streamRepository.invalidateFormat("${echo.music.enhanced.common.MERGING_DATA_TYPE.VIDEO}$currentVideoId")
