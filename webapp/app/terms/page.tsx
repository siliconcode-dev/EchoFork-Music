      ...
      <div className="mx-auto max-w-2xl px-6">
        ...
        <LegalSection title="3. No hosted content">
          <p>
            ...
            copyrighted media. All content remains hosted on Google/YouTube&apos;s
            servers and is the property of its respective owners.
          </p>
        </LegalSection>
        ...
        <LegalSection title="4. Third-party services">
          <p>
            ...
            Spotify, Apple Music lyrics). Availability of those endpoints is
            outside this project&apos;s control and may break without
        ...
        <LegalSection title="5. Support creators">
          <p>
            ...
            developer proof-of-concept, not a way to reduce creator revenue.
          </p>
        </LegalSection>
        ...
        <LegalSection title="6. User responsibility">
          <p>
            ...
            of any kind. Users are solely responsible for ensuring their use
            complies with local copyright laws and platform Terms of
            Service. No media is hosted by this project, so it cannot
            process DMCA takedowns for audio/video content.
          </p>
        </LegalSection>
        ...
        <LegalSection title="8. License">
          <p>
            ...
            <a href="/credits" className="text-accent-strong hover:underline">
              Credits
            </a>
            .
          </p>
