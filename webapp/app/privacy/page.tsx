    ...
    <div className="pb-24">
      ...
      <div className="mx-auto max-w-2xl px-6">
        ...
        <LegalSection title="This website">
          <p>
            This site doesn&apos;t have accounts, forms, or logins — there is
            nothing to sign up for. It uses{" "}
            <a
            ...
            for aggregated, privacy-respecting pageview data (no cookies, no
            cross-site tracking, no personal information collected). That&apos;s
            the extent of what this website itself collects.
          </p>
        </LegalSection>
        ...
        <LegalSection title="The Android app">
          ...
          <p>
            If you build the app from source, you can disable this entirely
            by removing the Firebase config or commenting out the two
            plugin lines in <code className="rounded bg-surface-card px-1.5 py-0.5">androidApp/build.gradle.kts</code> — see the{" "}
            <a href="/docs#source" className="text-accent-strong hover:underline">
              Docs
            </a>{" "}
            page.
          </p>
          <p>
            ...
            your device to those services using your own credentials or API
            keys — this project never sees or stores them.
          </p>
        </LegalSection>

        <LegalSection title="Third-party services">
          <p>
            The app talks to a number of third-party services directly from
            your device: YouTube Music (unofficial), Spotify (lyrics/canvas,
            unofficial), LRCLIB, SponsorBlock, and optionally Last.fm. Each
            is governed by its own privacy policy — this project has no
            visibility into, or control over, what those services do with
        ...
        <LegalSection title="Children's privacy">
          <p>
            This app and website aren&apos;t directed at children under 13,
            and no information is knowingly collected from them.
          </p>
        </LegalSection>
